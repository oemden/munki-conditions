...
if [[ "${InstallPantoneSwatches}" == 1 ]] ; then
   ...
   echo "	Missing PANTONE-V3 Swatch for one of your installed Adobe Apps; need to install the PANTONE-V3 Swatches"
   echo "  ====  ====  ====  ====  ====  ====  ====  ====  ====  ===="
